"""
glyph2sbs.py - A simple example of splitting left and right views from
a monochrome anaglyph image. Because the left and right eye views were
created from different colours you may need to adjust their brightness
and contrast levels individually to get a usable stereo pair.
"""
